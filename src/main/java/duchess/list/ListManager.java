...
public class ListManager {
    ...
    /**
     * Modifies an item in a specified list.
     */
    ...
    /**
     * Handles the addition of a deadline item to a list.
     */
    ...
    /**
     * Handles the addition of an event item to a list.
     */
    ...
    /**
     * Adds an item to a specified list, ensuring duplicate names are handled.
     */
    ...
    /**
     * Toggles the completion state of an item in a list.
     */
